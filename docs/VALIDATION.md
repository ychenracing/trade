...
与原已认证内容逐字节相同。五池共享引擎回归和显式关闭预算的历史对照不得冒充这份 AB5 正式结果。
...
另验证单股自适应、17 股生产回放及 2024 弱市路径，默认预算评估次数与真实权益采样日数一致。
...
2024 弱市同窗回归默认启用预算后的收益为 2.720470%，回撤为 -15.805129%，成交 14 笔；原关闭预算的收益 49.679035%、回撤 -17.219488%、18 笔成交保留在黄金元数据。这是默认启用带来的真实机会成本，不是格式误差，也不声称原 958 包含该窗口。
...
以下历史表是 `BacktestEngine`、200 万元、2025-04-01 至 2026-07-20、warm、未开启 AB5 预算的
...
| 2025—2026 历史一股牛市 | 530.8950% | -18.3414% | 24 | 5 | 与当时趋势基线完全一致 |
| 2025—2026 历史五股牛市 | 1170.7227% | -18.2206% | 216 | 99 | 与当时趋势基线完全一致 |
