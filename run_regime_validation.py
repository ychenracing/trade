...
OUTPUT = ROOT / "regime_validation_results.json"
...
GOLDEN_BULL = {
    "1_symbol": (5.308949754885001, -0.1834136674871038, 24),
    "3_symbols": (11.224308338588003, -0.1718499740402506, 176),
    "5_symbols": (12.122638251073752, -0.15671634443888668, 233),
    "13_symbols": (9.837623628753624, -0.1769204495836776, 231),
    "22_symbols": (10.58502564377175, -0.1691151189969806, 245),
}
...
def _run_bull(task: tuple[str, tuple[str, ...]]) -> dict[str, Any]:
    ...
    return {
        ...
        "strict_invariant": actual == expected,
    }
