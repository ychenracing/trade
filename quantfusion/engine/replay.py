...
def c6_diagnostic_engine_config(
    ...
    # Diagnostic identity explicitly owns its switch; production defaults must
    # never turn historical Base/ablation controls into AB5.
...
class ProductionReplayEngine:
    ...
    def validate_c6_diagnostic_request(
        ...
        """Validate the frozen, non-publishable v6 diagnostic request."""
