...
def execute_bound_binding(args: argparse.Namespace) -> int:
    ...
    producer_map = {
        "c6.s.qualification": ("c6.base.l1", "c6-v5-base-l1"),
        "c6.base_plus_s.l1": ("c6.s.qualification", "c6-v5-s-qualification"),
        "c6.base.selected.l4": ("c6.selected.l2", "c6-v5-base-l2"),
        "c6.base_plus_s.selected.l4": (
            "c6.selected.l2", "c6-v5-base-plus-s-l2"
        ),
    }
    direct_export = None
    direct_root = None
    ...
    if binding["record_id"] == "c6.base_plus_s.l1":
        ...
        store.producer(
            ...
            expected_logical_run="c6-v5-base-l1",
            workflow=binding["workflow"],
            run_bindings_revision=args.run_bindings_revision,
