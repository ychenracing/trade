...
class DispatchTests(unittest.TestCase):
    def setUp(self):
        self.record = {'workflow_binding_id': 'c6.s.qualification', 'logical_run_id': 'c6-v29-s-qualification',
        ...
        self.claim = {'record_id': 'c6.base.l1', 'workflow_run_id': '42', 'attempt_id': 'a0',
                      'logical_run_id': 'c6-v29-base-l1', 'artifact_full_byte_sha256': '3' * 64}
    ...
    def test_any_existing_attempt_blocks_initial_dispatch(self):
        prefix = 'c6-bound-c6.s.qualification-c6-v29-s-qualification-'
...
class ProbeTests(unittest.TestCase):
    def test_cancelled_latest_attempt_is_a_cheap_terminal_skip(self):
        history = [
            {'id': 10, 'display_title': 'c6-bound-c6.base.l1-c6-v29-base-l1-r9',
             'status': 'completed', 'conclusion': 'success'},
            {'id': 11, 'display_title': 'c6-bound-c6.base.l1-c6-v29-base-l1-r10',
    ...
    def test_successful_latest_attempt_can_be_inspected(self):
        history = [
            {'id': 12, 'display_title': 'c6-bound-c6.base.l1-c6-v29-base-l1-r11',
             'status': 'completed', 'conclusion': 'success'},
        ]
        ready, state = relay.probe_history(history)
    ...
    def test_active_attempt_blocks_expensive_inspection(self):
        history = [
            {'id': 13, 'display_title': 'c6-bound-c6.base.l1-c6-v29-base-l1-r12',
...
class NativeExportTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.record = {'record_id': 'synthetic.selected.l2', 'workflow_binding_id': 'c6.selected.l2',
                       'logical_run_id': 'c6-v29-synthetic-l2', 'candidate_id': 'C6-Base', 'stage': 'L2',
        ...
        self.run = {'id': 42, 'status': 'completed', 'conclusion': 'success', 'run_attempt': 1,
                    ...
                    'display_title': 'c6-bound-c6.selected.l2-c6-v29-synthetic-l2-a0'}
        ...
        self.instance.store = SimpleNamespace(
            _pages=lambda *a: [{'name': 'c6-bound-c6-v29-synthetic-l2-a0'}],
...
class APISafetyTests(unittest.TestCase):
    ...
    def make_dispatcher(self, *, ambiguous=False):
        ...
        obj.records = {'c6.base.selected.l4': {
            'workflow_binding_id': 'c6.selected.l4', 'logical_run_id': 'c6-v29-base-l4',
        ...
        producer = {'record_id': 'c6.base.selected.l2', 'artifact_full_byte_sha256': '1' * 64,
                    'attempt_id': 'a0', 'workflow_run_id': '42', 'logical_run_id': 'c6-v29-base-l2'}
