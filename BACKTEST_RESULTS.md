...
本文件只记录当前代码仍然有效的验证结论。生产趋势引擎没有在本轮外层路由与弱市风控修复中修改，因此 1、3、5、13、22 只股票的精确收益、最大回撤和交易次数基线保持不变。
...
这些数值只表示特定科技产业链股票池在特定历史阶段的结果，不代表任意股票池、任意时间或未来行情能够取得类似收益。
...
2. 两只指数证据完整但趋势未确认：选择正 240 日动量前三名；
